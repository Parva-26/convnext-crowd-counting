...
|-------|-------|--------|-------|
| **ConvNeXt + FPN (ours)** | **[Your Result]** | **[Your Result]** | Trained for 150/300 epochs |
...
4. ⚠️ **Domain gap remains** — Model trained on crowd scenes (50-300 people) undercounts sparse scenes (1-5 people)
